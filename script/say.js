module.exports.config = {
	...
	usages: "[ru/en/ko/ja/tl/ne/bn/mr/gu/hi/zh] [Text]",
	cooldowns: 5,
	dependencies: {
		"path": "",
		"fs-extra": ""
...
module.exports.run = async function({ api, event, args }) {
	try {
		...
		var languageToSay = (["ru","en","ko","ja","tl","ne","bn","mr","gu","hi", "zh"].some(item => content.indexOf(item) == 0)) ? content.slice(0, content.indexOf(" ")) : global.config.language;
